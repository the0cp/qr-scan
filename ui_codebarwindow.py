...
class Ui_CodeBarWindow(object):
    def setupUi(self, CodeBarWindow):
        ...
        self.copy_button.setGeometry(QRect(300, 0, 35, 35))
        icon1 = QIcon()
        ...
        self.open_button.setGeometry(QRect(335, 0, 35, 35))
        icon2 = QIcon()
    ...
    def retranslateUi(self, CodeBarWindow):
        ...
        self.close_button.setText(QCoreApplication.translate("CodeBarWindow", u"Close", None))
